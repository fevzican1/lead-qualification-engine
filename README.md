...
| Cron kademelendirme (10/15/20/25 dk keşif; 30/40/60 dk modüller) | `oracle/dispatch_hub.py` `DISPATCH_MATRIX`: CDX filoları 10/15/20/25 dk (birbirinden ayrık, cascade yok), discovery-pipeline 10 dk, watchdog'lar 30 dk, payload_optimizer 40 dk, enterprise-feed 60 dk, ağır zincir 2 saat. GitHub cron'u yedek katman. |
