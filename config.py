...
FORM_DELAY_STRICT_MIN_SECONDS: float = _get_float("FORM_DELAY_STRICT_MIN_SECONDS", 45.0)
FORM_DELAY_STRICT_MAX_SECONDS: float = _get_float("FORM_DELAY_STRICT_MAX_SECONDS", 60.0)
# Stale .env 15–30 starved the hourly 20; WAF delay is unchanged.
...
PIPELINE_TIMEOUT_SECONDS: int = _get_int("PIPELINE_TIMEOUT_SECONDS", 1_500)
...
SITE_TIMEOUT_SECONDS: int = _get_int("SITE_TIMEOUT_SECONDS", 90)
